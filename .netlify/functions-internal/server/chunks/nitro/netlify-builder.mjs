globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { builder } from '@netlify/functions';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "SQUARE_APPLICATION_ID": "sandbox-sq0idb-jKTfLWkeaL6AkVCzNP7EwA",
    "SQUARE_LOCATION_ID": "LMBWMV0Z9190V",
    "PAYPAL_CLIENT_ID": "AZbORn2GNysVd4kbr0FCoTLz8GgvCXzxsYF8t8NZ05rMDAcS6h_O74lfSlkm6Sb2dRmvr89qgWWSjIet",
    "persistedState": {
      "storage": "cookies",
      "debug": false,
      "cookieOptions": {}
    ...
    "pwaManifest": {
      ...
      "icons": [
        {
          "src": "/_nuxt/icons/64x64.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/64x64.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/120x120.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/120x120.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/144x144.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/144x144.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/152x152.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/152x152.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/192x192.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/192x192.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/384x384.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/384x384.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/512x512.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/512x512.maskable.6a3b6f2e.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "maskable"
        }
  ...
  "sendgrid": {
    "apiKey": "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",
    "senderEmail": "info@novanet.studio",
    "receiverEmail": "info@novanet.studio"
  },
  "strapi": {
    "url": "http://localhost:1337",
    "prefix": "/api",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/dave/Desktop/dev/work/novanet/cms-tem/frontend/.data/kv"}));
...
const _kfyfSr2F6N = (function(nitro) {
...
const _gsuvnY = lazyEventHandler(() => {
...
const _lazy_psquew = () => import('../create-customer.post.mjs');
const _lazy_QvDQQw = () => import('../payment.post.mjs');
const _lazy_PXMn6v = () => import('../send-merchant-email.post.mjs');
const _lazy_qKqE5N = () => import('../send-receipt-email.post.mjs');
const _lazy_IGjhUR = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/create-customer', handler: _lazy_psquew, lazy: true, middleware: false, method: "post" },
  { route: '/api/payment', handler: _lazy_QvDQQw, lazy: true, middleware: false, method: "post" },
  { route: '/api/send-merchant-email', handler: _lazy_PXMn6v, lazy: true, middleware: false, method: "post" },
  { route: '/api/send-receipt-email', handler: _lazy_qKqE5N, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_IGjhUR, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _gsuvnY, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IGjhUR, lazy: true, middleware: false, method: undefined }
];
...
export { defineEventHandler as a, send as b, createError$1 as c, dr as d, eventHandler as e, setResponseStatus as f, getResponseStatus as g, setResponseHeaders as h, useNitroApp as i, joinURL as j, getQuery as k, getRouteRules as l, getResponseStatusText as m, handler as n, readBody as r, setResponseHeader as s, useRuntimeConfig as u, wn as w };
//# sourceMappingURL=netlify-builder.mjs.map
